...
**Career signal:** VS Code extension authorship is a niche skill that stands out. Extending an existing project ([vicode](https://github.com/carlosferreyra/vicode)) shows continuity of ownership.
